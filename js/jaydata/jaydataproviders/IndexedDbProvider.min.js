...
a},"$data.GeometryMultiLineString":function(a){return a?new $data.GeometryMultiLineString(a):a},"$data.GeometryMultiPolygon":function(a){return a?new $data.GeometryMultiPolygon(a):a},"$data.GeometryCollection":function(a){return a?new $data.GeometryCollection(a):a}},toDb:{"$data.Integer":function(a){return a},"$data.Number":function(a){return a},"$data.Date":function(a){return a},"$data.String":function(a){return a},"$data.Boolean":function(a){return a},"$data.Blob":function(a){return a},"$data.Array":function(a){return a},
"$data.Object":function(a){return a},"$data.Guid":function(a){return a?a.value:a},"$data.GeographyPoint":function(a){return a},"$data.GeographyLineString":function(a){return a},"$data.GeographyPolygon":function(a){return a},"$data.GeographyMultiPoint":function(a){return a},"$data.GeographyMultiLineString":function(a){return a},"$data.GeographyMultiPolygon":function(a){return a},"$data.GeographyCollection":function(a){return a},"$data.GeometryPoint":function(a){return a},"$data.GeometryLineString":function(a){return a},
"$data.GeometryPolygon":function(a){return a},"$data.GeometryMultiPoint":function(a){return a},"$data.GeometryMultiLineString":function(a){return a},"$data.GeometryMultiPolygon":function(a){return a},"$data.GeometryCollection":function(a){return a}}}},_getObjectStoreDefinition:function(a){var b={storeName:a.TableName},a=a.PhysicalType.memberDefinitions.getKeyProperties();if(0==a.length)throw b=Error("Entity must have a key field: "+b.storeName),b.name="KeyNotFoundError",b;for(var c=0;c<a.length;c++){if(!0===
a[c].computed&&"$data.Integer"!==Container.resolveName(a[c].type))throw b=Error("Computed key field must be of integer type: "+b.storeName),b.name="ComputedKeyFieldError",b;if(2<a.length&&a[c].computed)throw b=Error("With multiple keys the computed field is not allowed: "+b.storeName),b.name="MultipleComputedKeyFieldError",b;}b.keyFields=a;return b},_getObjectStoreDefinitions:function(){var a=[],b=this;b.context._storageModel.forEach(function(c){c=b._getObjectStoreDefinition(c);a.push(c)});return a},
_oldCreateDB:function(a,b,c){a.db.onversionchange=function(a){return a.target.close()};this._createDB(a.db,b);a.oncomplete=c},_createDB:function(a,b){for(var c=0;c<b.length;c++)b[c].dropIfExists&&a.objectStoreNames.contains(b[c].storeName)&&a.deleteObjectStore(b[c].storeName);for(c=0;c<b.length;c++){var d=b[c];if(!a.objectStoreNames.contains(d.storeName)){var e={};if(1==d.keyFields.length)e={keyPath:d.keyFields[0].name,autoIncrement:d.keyFields[0].computed};else{e.key=[];for(c=0;c<d.keyFields.length;c++)e.key.push(d.keyFields[c].name)}a.createObjectStore(d.storeName,
e)}}},_hasDbChanges:function(a,b,c){for(var d=!0,e=0;e<b.length;e++)d=d&&a.objectStoreNames.contains(b[e].storeName),c&&(b[e].dropIfExists=!0,d=!1);return!d},onupgradeneeded:function(a){var b=this;return function(c){c=c.target.result;c.onversionchange=function(a){return a.target.close()};b._hasDbChanges(c,a,b.providerConfiguration.dbCreation==$data.storageProviders.DbCreationType.DropAllExistingTables)&&b._createDB(c,a)}},initializeStore:function(a){var a=$data.typeSystem.createCallbackSetting(a),
b=this;this.initializeMemoryStore({success:function(){var c;try{c=b._getObjectStoreDefinitions()}catch(d){console.log(c);a.error(d);return}b.indexedDB.open(b.providerConfiguration.databaseName).setCallbacks({onsuccess:function(d){d=d.target.result;d.onversionchange=function(a){return a.target.close()};var f=b._hasDbChanges(d,c,b.providerConfiguration.dbCreation==$data.storageProviders.DbCreationType.DropAllExistingTables);if(d.setVersion){if(""===d.version||f){d.setVersion((parseInt(d.version)||0)+
1).setCallbacks({onsuccess:function(d){b._oldCreateDB(d.target.result,c,function(c){b.db=c.target.db;a.success(b.context)})},onerror:function(){},onblocked:function(){}});return}}else if(f){d.close();d=parseInt(d.version)+1;b.indexedDB.open(b.providerConfiguration.databaseName,d).setCallbacks({onsuccess:function(c){b.db=c.target.result;a.success(b.context)},onupgradeneeded:b.onupgradeneeded(c),onerror:a.error,onabort:a.error,onblocked:a.error});return}b.db=d;a.success(b.context)},onupgradeneeded:b.onupgradeneeded(c),
onerror:a.error,onabort:a.error,onblocked:a.error})},error:a.error})},initializeMemoryStore:function(a){var a=$data.typeSystem.createCallbackSetting(a),b=this;b.originalContext&&b.providerConfiguration.memoryOperations?(b.operationProvider=new b.originalContext({name:"InMemory"}),b.operationProvider.onReady({success:function(){b.supportedBinaryOperators=b.operationProvider.storageProvider.supportedBinaryOperators;b.supportedSetOperations=b.operationProvider.storageProvider.supportedSetOperations;
b.supportedFieldOperations=b.operationProvider.storageProvider.supportedFieldOperations;b.supportedUnaryOperators=b.operationProvider.storageProvider.supportedUnaryOperators;a.success()},error:a.error})):a.success()},_initializeStore:function(a){var a=$data.typeSystem.createCallbackSetting(a),b=this,c=function(a){a.onversionchange=function(a){return a.target.close()};var c=[];b.context._storageModel.forEach(function(d){function e(){var i={},g=b._getKeySettings(d);b.newVersionAPI?g.autoIncrement&&
c.push(d.TableName):i.autoIncrement=g.autoIncrement;void 0!==g.keyPath&&(i.keyPath=g.keyPath);a.createObjectStore(d.TableName,i)}a.objectStoreNames.contains(d.TableName)?b.providerConfiguration.dbCreation===$data.storageProviders.DbCreationType.DropAllExistingTables&&(a.deleteObjectStore(d.TableName),e()):e()});0<c.length&&!a.objectStoreNames.contains(b.sequenceStore)&&(a.createObjectStore(b.sequenceStore,{keyPath:"store"}),c=[]);return c},d=null,e={onupgradeneeded:function(a){d=c(a.target.result)},
onerror:a.error,onblocked:a.error,onsuccess:function(f){b.db=f.target.result;b.db.onversionchange=function(a){a.target.close()};if(b.newVersionAPI){if(d&&0<d.length){var e=b.db.transaction([b.sequenceStore],b.IDBTransactionType.READ_WRITE).setCallbacks({onerror:a.error,oncomplete:function(){a.success(b.context)}}).objectStore(b.sequenceStore);switch(b.providerConfiguration.dbCreation){case $data.storageProviders.DbCreationType.DropAllExistingTables:case $data.storageProviders.DbCreationType.DropTableIfChanged:e.clear();
break;default:d.forEach(function(a){e["delete"](a)})}}a.success(b.context)}else var h=b.db.setVersion(b.providerConfiguration.version.toString()).setCallbacks({onerror:a.error,onblocked:a.error,onsuccess:function(){c(b.db);h.result.oncomplete=function(){a.success(b.context)}}})}};b.newVersionAPI?b.indexedDB.open(b.providerConfiguration.databaseName,parseInt(b.providerConfiguration.version,10)).setCallbacks(e):b.indexedDB.open(b.providerConfiguration.databaseName).setCallbacks(e)},executeQuery:function(a,
b){var b=$data.typeSystem.createCallbackSetting(b),c=this,d=a.context.getEntitySetFromElementType(a.defaultType),e=c.db.transaction([d.tableName],c.IDBTransactionType.READ_ONLY).setCallbacks({onerror:b.error,onabort:b.error,oncomplete:function(){c.operationProvider?(c.operationProvider.storageProvider.providerConfiguration.source[d.tableName]=a.rawDataList,c.operationProvider.storageProvider.executeQuery(a,{success:function(a){a.expression.nodeType===$data.Expressions.ExpressionType.Count&&(a.rawDataList[0]=
{cnt:a.rawDataList[0]});b.success(a)},error:b.error})):b.success(a)}}).objectStore(d.tableName);Container.createModelBinderConfigCompiler(a,[]).Visit(a.expression);if(c.operationProvider)e.openCursor().onsuccess=function(b){if(b=b.target.result)a.rawDataList.push(b.value),b["continue"]()};else switch(a.expression.nodeType){case $data.Expressions.ExpressionType.Count:e.count().onsuccess=function(b){a.rawDataList.push({cnt:b.target.result})};break;default:e.openCursor().onsuccess=function(b){if(b=b.target.result)a.rawDataList.push(b.value),
b["continue"]()}}},_getKeySettings:function(a){var b={autoIncrement:!1},c=[];a.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(a){a.key&&c.push(a.name);a.computed&&(a.key||Guard.raise(new Exception("Only key field can be a computed field!")),b.autoIncrement=!0)});1<c.length?(b.autoIncrement&&Guard.raise(new Exception("Auto increment is only valid for a single key!")),b.keys=c):1==c.length?b.keyPath=c[0]:Guard.raise(new Exception("No valid key found!"));return b},saveChanges:function(a,
b){function c(){if(0===e.length)a.success();else{var b={},j=e.shift().map(function(a){b[a.entitySet.tableName]=!0;a.physicalData={};d.context._storageModel.getStorageModel(a.data.getType()).PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(b){if(!b.key||!(b.computed&&void 0==a.data[b.name]))if("undefined"===typeof b.concurrencyMode&&(!0===b.key||a.data.entityState===$data.EntityState.Added||a.data.changedProperties&&a.data.changedProperties.some(function(a){return a.name===
b.name}))){var c=Container.resolveName(b.type);d.fieldConverter.toDb[c]?a.physicalData[b.name]=d.fieldConverter.toDb[c](a.data[b.name]):(console.log("WARN!!!"),a.physicalData[b.name]=a.data[b.name])}});return a}),h=[],g;for(g in b)h.push(g);var i=d.db.transaction(h,d.IDBTransactionType.READ_WRITE).setCallbacks({onerror:function(b){b.target.errorCode!==d.IDBDatabaseException.ABORT_ERR&&a.error(b)},oncomplete:function(){c()}}),k=new function(){var a={};this.getSettingsForItem=function(b){var c=b.data.getType().fullName;
a.hasOwnProperty(c)||(a[c]=d._getKeySettings(d.context._storageModel.getStorageModel(b.data.getType())));return a[c]}};j.forEach(function(b){var c=i.objectStore(b.entitySet.tableName),e=k.getSettingsForItem(b),g=e.keys&&e.keys.map(function(a){return b.physicalData[a]})||null;try{var f=function(l){var f=e.keyPath?b.physicalData[e.keyPath]:g,h=b.physicalData;c.openCursor(d.IDBKeyRange.only(f)).onsuccess=function(c){try{var d=c.target.result;d?l(d,f,h):Guard.raise(new Exception("Object not found",null,
b))}catch(e){i.abort(),a.error(e)}}};switch(b.data.entityState){case $data.EntityState.Added:e.keyPath?c.add(b.physicalData).onsuccess=function(a){b.data[e.keyPath]=a.target.result}:c.add(b.physicalData,g);break;case $data.EntityState.Deleted:f(function(a){a["delete"]()});break;case $data.EntityState.Modified:f(function(a,b,c){a.update($data.typeSystem.extend(a.value,c))});break;case $data.EntityState.Unchanged:break;default:Guard.raise(new Exception("Not supported entity state",null,b))}}catch(h){i.abort(),
