...
fieldConverter:{value:{fromDb:{"$data.Number":function(b){return"number"===typeof b?b:parseInt(b)},"$data.Integer":function(b){return"number"===typeof b?b:parseFloat(b)},"$data.String":function(b){return b},"$data.Date":function(b){return new Date("string"===typeof b?parseInt(b):b)},"$data.Boolean":function(b){return!!b},"$data.Blob":function(b){return b},"$data.Array":function(b){return void 0===b?new $data.Array:b}},toDb:{"$data.Number":function(b){return b},"$data.Integer":function(b){return b},
"$data.String":function(b){return"'"+b+"'"},"$data.Date":function(b){return b?b.valueOf():null},"$data.Boolean":function(b){return b},"$data.Blob":function(b){return b},"$data.Array":function(b){return"("+b.join(", ")+")"}}}},executeQuery:function(b,a){var c=this,a=$data.typeSystem.createCallbackSetting(a),d=b.defaultType,e=b.context.getType().memberDefinitions.asArray().filter(function(a){return a.elementType==d})[0]||{};this.AuthenticationProvider||(this.AuthenticationProvider=new $data.Authentication.Anonymous({}));
var g;try{g=this._compile(b)}catch(i){a.error(i);return}g={url:this.providerConfiguration.YQLQueryUrl+encodeURIComponent(g.queryText)+"&"+this.providerConfiguration.YQLFormat+(this.providerConfiguration.YQLEnv?"&env="+this.providerConfiguration.YQLEnv:""),dataType:"JSON",success:function(d){d=c._preProcessData(d,e);if(d!=false){b.rawDataList=d;e.anonymousResult?b.rawDataList=d:Container.createModelBinderConfigCompiler(b,[]).Visit(b.expression)}a.success(b)},error:function(b,c,d){c={};try{c=JSON.parse(b.responseText).error}catch(g){c=
d+": "+b.responseText}a.error(c)}};this.context.prepareRequest.call(this,g);this.AuthenticationProvider.CreateRequest(g)},_preProcessData:function(b,a){for(var c=b,d=void 0!=a.resultPath?a.resultPath:this.providerConfiguration.resultPath,e=0;e<d.length;e++)if(c[d[e]])c=c[d[e]];else return!1;if(!0==(void 0!=a.resultSkipFirstLevel?a.resultSkipFirstLevel:this.providerConfiguration.resultSkipFirstLevel))if(d=Object.keys(c),1==d.length&&(c[d[0]]instanceof Array||!a.anonymousResult))c=c[d[0]];return c.length?
c:[c]},_compile:function(b){return Container.createYQLCompiler().compile(b)},getTraceString:function(b){this.AuthenticationProvider||(this.AuthenticationProvider=new $data.Authentication.Anonymous({}));return this._compile(b)},setContext:function(b){this.context=b},saveChanges:function(){Guard.raise(new Exception("Not Implemented","Not Implemented"))}},null);$data.StorageProviderBase.registerProvider("YQL",$data.storageProviders.YQL.YQLProvider);
...
a.takeSql.sqlSuf=")")},VisitSimpleBinaryExpression:function(b,a){a.sql+="(";this.Visit(b.left,a);a.sql+=b.resolution.mapTo;b.resolution.resolvableType&&!Guard.requireType(b.resolution.mapTo+" expression.right.value",b.right.value,b.resolution.resolvableType)&&Guard.raise(new Exception(b.right.type+" not allowed in '"+b.resolution.mapTo+"' statement","invalid operation"));this.Visit(b.right,a);a.sql+=")"},VisitEntityFieldExpression:function(b,a){this.Visit(b.source,a);this.Visit(b.selector,a)},VisitMemberInfoExpression:function(b,
a){var c;!0===a.wasComplex&&(a.sql+=".");a.sql+=b.memberName;!0==a.isComplex?(a.complex+=b.memberName,a.wasComplex=!0):(a.wasComplex=!1,c=a.complex?a.complex+b.memberName:b.memberName,a.complex=null,a.fieldData={name:c,dataType:b.memberDefinition.dataType},"Projection"==a.type&&!a.selectFields&&(a.selectFields=[{from:c,dataType:b.memberDefinition.dataType}]))},VisitConstantExpression:function(b,a){"Projection"==a.type&&Guard.raise(new Exception("Constant value is not supported in Projection.","Not supported!"));
this.VisitQueryParameterExpression(b,a)},VisitQueryParameterExpression:function(b,a){a.value=b.value;var c=Container.resolveType(Container.getTypeName(b.value));if(-1!=this.provider.supportedDataTypes.indexOf(c))a.sql+=this.provider.fieldConverter.toDb[Container.resolveName(c)](b.value);else switch(c){case $data.Queryable:a.sql+="("+b.value.toTraceString().queryText+")";break;default:a.sql+=""+b.value+""}},VisitParametricQueryExpression:function(b,a){if("Projection"==a.type){if(this.Visit(b.expression,
a),b.expression instanceof $data.Expressions.ComplexTypeExpression){a.selectFields=a.selectFields||[];var c=b.expression.entityType,d=this._getComplexTypeIncludes(c);a.selectFields.push({from:a.complex,type:c,includes:d})}}else this.Visit(b.expression,a),a.parameters=b.parameters},VisitEntitySetExpression:function(b,a){a.type?a.complex||(a.complex=""):a.tableName=b.instance.tableName},VisitObjectLiteralExpression:function(b,a){var c=this;a.selectFields=a.selectFields||[];b.members.forEach(function(b){if(b.expression instanceof
$data.Expressions.ObjectLiteralExpression)a.mappingPrefix=a.mappingPrefix||[],a.mappingPrefix.push(b.fieldName),c.Visit(b,a),a.mappingPrefix.pop();else{0<a.selectFields.length&&(a.sql+=", ");c.Visit(b,a);b={from:a.fieldData.name,to:a.mappingPrefix instanceof Array?a.mappingPrefix.join(".")+"."+b.fieldName:b.fieldName};if(a.selectType){b.type=a.selectType;var e=this._getComplexTypeIncludes(a.selectType);b.includes=e}else b.dataType=a.fieldData.dataType;a.selectFields.push(b);delete a.fieldData;delete a.selectType}},
this)},VisitObjectFieldExpression:function(b,a){this.Visit(b.expression,a);b.expression instanceof $data.Expressions.ComplexTypeExpression&&(a.fieldData=a.fieldData||{},a.fieldData.name=a.complex,a.selectType=b.expression.entityType)},VisitEntityFieldOperationExpression:function(b,a){Guard.requireType("expression.operation",b.operation,$data.Expressions.MemberInfoExpression);var c=b.operation.memberDefinition,d=c.mapTo||c.name;a.sql+="(";!1==c.expressionInParameter&&this.Visit(b.source,a);a.sql+=
d;var e=0;(c.parameters||[]).map(function(a){var c={dataType:a.dataType,prefix:a.prefix,suffix:a.suffix};a.value?c.value=a.value:"@expression"===a.name?c.value=b.source:(c.value=b.parameters[e],c.itemType=b.parameters[e++].type);return c}).forEach(function(c,e){var f=c.itemType?Container.resolveType(c.itemType):null;if(!f||c.dataType instanceof Array&&-1!=c.dataType.indexOf(f)||c.dataType==f)if(0<e&&(a.sql+=", "),f={sql:""},this.Visit(c.value,f)," LIKE "==d){var h=Container.getTypeName(f.value);a.sql+=
"string"==h?"'":"";a.sql+=(c.prefix?c.prefix:"")+f.value+(c.suffix?c.suffix:"");a.sql+="string"==h?"'":""}else a.sql+=f.sql;else Guard.raise(new Exception(parameter.type+" not allowed in '"+b.operation.memberName+"' statement","invalid operation"))},this);a.sql=c.rigthValue?a.sql+c.rigthValue:a.sql+"";a.sql+=")"},VisitComplexTypeExpression:function(b,a){this.Visit(b.source,a);a.isComplex=!0;this.Visit(b.selector,a);a.isComplex=!1;""!=a.complex&&(a.complex+=".")},VisitEntityExpression:function(b,a){this.Visit(b.source,
a)},_findComplexType:function(b,a,c){b.memberDefinitions.getPublicMappedProperties().forEach(function(b){var e=Container.resolveType(b.dataType);e.isAssignableTo&&!e.isAssignableTo($data.EntitySet)&&(b=c?c+"."+b.name:b.name,a.push({name:b,type:e}),this._findComplexType(e,a,b))},this)},_getComplexTypeIncludes:function(b){if(!this.cTypeCache[b.name]){var a=[];this._findComplexType(b,a);this.cTypeCache[b.name]=a}return this.cTypeCache[b.name]}},null);
$data.Class.define("$data.Yahoo.types.Geo.placeTypeNameCf",$data.Entity,null,{code:{type:"string"},content:{type:"string"}},null);$data.Class.define("$data.Yahoo.types.Geo.countryCf",$data.Entity,null,{code:{type:"string"},type:{type:"string"},content:{type:"string"}},null);$data.Class.define("$data.Yahoo.types.Geo.adminCf",$data.Entity,null,{code:{type:"string"},type:{type:"string"},content:{type:"string"}},null);
$data.Class.define("$data.Yahoo.types.Geo.localityCf",$data.Entity,null,{code:{type:"string"},content:{type:"string"}},null);$data.Class.define("$data.Yahoo.types.Geo.centroidCf",$data.Entity,null,{latitude:{type:"string"},longitude:{type:"string"}},null);$data.Class.define("$data.Yahoo.types.Geo.postalCf",$data.Entity,null,{type:{type:"string"},content:{type:"string"}},null);
$data.Class.define("$data.Yahoo.types.Geo.boundingBoxCf",$data.Entity,null,{southWest:{type:"centroidRef"},northEast:{type:"centroidRef"}},null);$data.Class.define("$data.Yahoo.types.Geo.PlaceMeta",null,null,{woeid:{type:"int",key:!0},name:{type:"string"},uri:{type:"string"},placeTypeName:{type:"placeTypeNameRef"},lang:{type:"string"}},null);
